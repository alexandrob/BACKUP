...
########################################################
### Caminho para armazenamento. Montar pela interface admin e trocar UUID
backup_dir="/var/run/sr-mount/<UUID_do_armazenamento>/"
backup_ext=".xva"
...
vm_backup_list=()
########################################################
###  Lista de VM a realizar backup
#VM001
vm_backup_list[1]="<UUID_da_VM>"
# Repita abaixo caso exista outras VM
